...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class PrjStepper extends StatefulWidget {
...
class _StepperState extends State<Stepper> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    for (int i = 0; i < widget.steps.length; i += 1) {
      _oldStates[i] = widget.steps[i].state as StepState;
    }
  }
  ...
  void didUpdateWidget(Stepper oldWidget) {
    ...
    for (int i = 0; i < oldWidget.steps.length; i += 1)
      _oldStates[i] = oldWidget.steps[i].state as StepState;
  }
  ...
  TextStyle _titleStyle(int index) {
    ...
    switch (widget.steps[index].state  as StepState) {
      case StepState.indexed:
      case StepState.editing:
      case StepState.complete:
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.type as StepperType) {
