...
class _SignUpController extends State<SignUpView> {
  ...
  _openGallery(BuildContext context) async {
    ...
    this.setState(() {
      imageFile = picture;
      if (imageFile != null) cam.text = "Done";
    });
  ...
  void verificationRequest() {
    telephony.sendSms(
        ...
        message: "<#> " +
            random +
            " Verification Code from Skrrt, your Rent-a-Scooter App. Please don't reply to this message. Thank you and welcome to the family! SKRRT SKRRT!");
  }
                  ...
                  children: <Widget>[
                      ...
                      children: [
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            hint:
                                Text(selectedRadio == 1 ? 'Course' : 'College',
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontFamily: 'Quicksand',
                                    )),
                        ...
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            hint:
                                Text(selectedRadio == 1 ? 'Year' : 'Department',
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontFamily: 'Quicksand',
                                    )),
                    ...
                    TextFormField(
                      ...
                      validator: (String value) {
                        ...
                        } else if (!RegExp('[0-9]{2}[-][0-9]{4}[-][0-9]{3}\$')
                            .hasMatch(value)) {
                          return 'Must be in correct format (ex: 12-2525-969)';
                        } else {
                          if (username.text == "") username.text = idno.text;
                          if (pass.text == "") pass.text = idno.text;
                          return null;
                        }
                      },
                      decoration: InputDecoration(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Padding(
                                  ...
                                  child: Icon(
                                    Icons.lock_rounded,
                                    color:
                                        Color.fromARGB(255, 0x00, 0xA8, 0xE5),
                                    size: 15,
                                  ),
                                ),
                              ),
